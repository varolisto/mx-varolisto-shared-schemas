...
export const paso5Schema = z
  .object({
    ...
    ref1Telefono: zStr().refine(isValidTelefonoMx, 'Ingresa un teléfono válido de 10 dígitos'),
    ...
    ref2Nombre: zStr()
      ...
      .max(100, 'Máximo 100 caracteres')
      .regex(/^[a-zA-ZáéíóúÁÉÍÓÚüÜñÑ\s'-]+$/, 'Solo se permiten letras'),
    ref2Telefono: zStr().refine(isValidTelefonoMx, 'Ingresa un teléfono válido de 10 dígitos'),
