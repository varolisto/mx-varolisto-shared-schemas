...
export const actualizarDatosPersonalesAdminRequestSchema = z.object({
  ...
  avalNombre: z.string().min(3, "Mínimo 3 caracteres").max(150, "Máximo 150 caracteres").optional(),
  ...
  .refine(
    ...
    {
      message: "Si capturas datos del aval, debes proporcionar nombre, número de identificación y teléfono",
      path: ["avalNombre"],
    }
  )

export type ActualizarDatosPersonalesAdminRequest = z.infer<typeof actualizarDatosPersonalesAdminRequestSchema>
